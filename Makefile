...
sh4_mmu_test.elf: init.o main.o irq.o tlb_miss.o
	$(CC) -Wl,-e_start,-Ttext,0x8c010000 init.o main.o irq.o tlb_miss.o -o sh4_mmu_test.elf -nostartfiles -nostdlib -lgcc -m4 -g
